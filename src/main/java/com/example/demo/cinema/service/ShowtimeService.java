...
public class ShowtimeService {
    ...
    public List<Showtime> findAvailableShowtimes(Long movieId, LocalDate showDate, String experience) {
        ...
        if (StringUtils.hasText(experience)) {
            return showtimeRepository.findByMovieIdAndShowDateAndExperienceIgnoreCaseOrderByStartTimeAsc(movieId,
                    dateToFilter, experience);
        } else {
    ...
    public List<LocalDate> findAvailableDatesForMovie(Long movieId) {
        ...
        // *** QUAN TRỌNG: Đảm bảo phương thức findDistinctShowDatesByMovieId tồn tại
        // trong ShowtimeRepository ***
    ...
    public List<String> findAvailableExperiencesForMovieAndDate(Long movieId, LocalDate showDate) {
        ...
        // findDistinctExperiencesByMovieIdAndShowDate tồn tại trong ShowtimeRepository
        // ***
    ...
    public List<LocalDate> findAllAvailableShowtimeDates() {
        ...
        // *** QUAN TRỌNG: Đảm bảo phương thức findDistinctShowDatesAfter tồn tại trong
        // ShowtimeRepository ***
        ...
        // return showtimeRepository.findAllDistinctShowDates(); // Cần tạo phương thức
        // này trong repo
    }
}